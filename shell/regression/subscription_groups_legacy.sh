...
subscription-remote-idempotent)
    ...
    ;;
subscription-tx)
    regressionRunner=runRegressionSubscriptionTx
    ;;
sing-box-subscribe-write)
...
regression-subscription-tx-parallel-composition)
    regressionRunner=runRegressionSubscriptionTxParallelCompositionRegression
    ;;
