...
runRegressionSubscriptionRemoteParallelCompositionRegression() (
    ...
    runRemoteSubscribeFetchRegression() { runRegressionAllSelector subscription-remote; }
    ...
    PADM_REGRESSION_SUBSCRIPTION_REMOTE_PARALLEL_JOBS=1 runRegressionSubscriptionRemote
    awk '
...
runRegressionSubscriptionParallelCompositionRegression() (
    ...
    runRegressionSubscriptionRemote() { runRegressionAllSelector subscription-remote; }
    runRegressionSubscriptionWriteTransaction() { runRegressionAllSelector subscription-tx; }
...
runRegressionUiParallelCompositionRegression() (
    ...
    runMenuSmokeLightRegression() { runRegressionAllSelector ui-smoke; }
    runMenuSmokeRegression() { runRegressionAllSelector ui-full; }
...
runRegressionUiLongTailSplitCompositionRegression() (
    ...
    runMenuSmokeLightRegression() { runRegressionAllSelector ui-smoke; }
    runMenuSmokeRegression() { runRegressionAllSelector "ui-full:${1:-all}"; }
    runSubscriptionWireGuardRestoreRunnerRegression() { runRegressionAllSelector wireguard-restore-runner; }
...
subscription-state)
    ...
    ;;
subscription-remote)
    regressionRunner=runRegressionSubscriptionRemote
    ;;
subscription-remote-unique)
