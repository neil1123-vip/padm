...
registerRegressionFunctionLeaf ui-full-core runRegressionUiLegacyLeafWithCompat runMenuSmokeFullCoreRegression
registerRegressionFunctionLeaf ui-full-subscription-main-entry runRegressionUiLegacyLeafWithCompat runMenuSmokeFullSubscriptionMainEntryRegression
registerRegressionFunctionLeaf ui-full-subscription-main-publish-service runRegressionUiLegacyLeafWithCompat runMenuSmokeFullSubscriptionMainPublishServiceRegression
registerRegressionFunctionLeaf ui-full-subscription-main-publish-user-empty runRegressionUiLegacyLeafWithCompat runMenuSmokeFullSubscriptionMainPublishUserEmptyRegression
registerRegressionFunctionLeaf ui-full-subscription-main-publish-user-create runRegressionUiLegacyLeafWithCompat runMenuSmokeFullSubscriptionMainPublishUserCreateRegression
registerRegressionFunctionLeaf ui-full-subscription-main-publish-user-inspect runRegressionUiLegacyLeafWithCompat runMenuSmokeFullSubscriptionMainPublishUserInspectRegression
registerRegressionFunctionLeaf ui-full-subscription-main-publish-sync-skip runRegressionUiLegacyLeafWithCompat runMenuSmokeFullSubscriptionMainPublishSyncSkipRegression
registerRegressionFunctionLeaf ui-full-subscription-main-publish-sync-enable runRegressionUiLegacyLeafWithCompat runMenuSmokeFullSubscriptionMainPublishSyncEnableRegression
registerRegressionFunctionLeaf ui-full-subscription-main-maintenance runRegressionUiLegacyLeafWithCompat runMenuSmokeFullSubscriptionMainMaintenanceRegression
registerRegressionFunctionLeaf ui-full-subscription-controlled runRegressionUiLegacyLeafWithCompat runMenuSmokeFullSubscriptionControlledRegression
registerRegressionFunctionLeaf ui-full-core-maintenance runRegressionUiLegacyLeafWithCompat runMenuSmokeFullCoreMaintenanceRegression
...
registerRegressionFunctionLeaf wireguard-menu-flow-peer-add-update runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowPeerAddUpdateRegression
registerRegressionFunctionLeaf wireguard-menu-flow-peer-rollback-apply-service runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowPeerRollbackApplyServiceRegression
registerRegressionFunctionLeaf wireguard-menu-flow-peer-rollback-apply-restore runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowPeerRollbackApplyRestoreRegression
registerRegressionFunctionLeaf wireguard-menu-flow-peer-rollback-source runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowPeerRollbackSourceRegression
registerRegressionFunctionLeaf wireguard-menu-flow-peer-rollback-credential-write runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowPeerRollbackCredentialWriteRegression
registerRegressionFunctionLeaf wireguard-menu-flow-peer-rollback-credential-groups-restore runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowPeerRollbackCredentialGroupsRestoreRegression
registerRegressionFunctionLeaf wireguard-menu-flow-peer-source-control-toggle runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowPeerSourceControlToggleRegression
registerRegressionFunctionLeaf wireguard-menu-flow-peer-source-control-clear-error runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowPeerSourceControlClearErrorRegression
registerRegressionFunctionLeaf wireguard-menu-flow-peer-source-control-status runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowPeerSourceControlStatusRegression
registerRegressionFunctionLeaf wireguard-menu-flow-control-restore runRegressionUiLegacyLeafWithCompat runSubscriptionWireGuardMenuFlowControlRestoreRegression
