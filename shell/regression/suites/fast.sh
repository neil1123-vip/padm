...
_fast_platform_suite_def=$(declare -f runRegressionPlatform)
_fast_platform_suite_def="${_fast_platform_suite_def/runRegressionPlatform/runRegressionPlatformSuiteRoot}"
eval "${_fast_platform_suite_def}"
