    ...
    helperCount=$(
        {
            ...
            awk '/^(adapterWarpRepoTemplate|adapterWarpYumRepoTemplate|warpEnableAlwaysOn|warpRollbackProxy|enableWarpProxy|checkWarpProxyTrace|installWarp|warpCliHelpContains|warpRegister|warpSetProxyMode|warpSetProxyPort|adapterPackagesTempTemplate|adapterAcmeTmpDir|adapterAcmeInstallScriptPath|adapterAcmeDownloadTemplate)\(\) \{/ { count++ } END { print count + 0 }' "${PROJECT_ROOT}/shell/core/adapters.sh"
